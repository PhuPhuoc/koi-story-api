...
//	@Accept			json
//	@Produce		json
//	@Param			user	body		usermodel.UserLoginJustImage	true	"User log in info"
//	@Success		200		{object}	map[string]interface{}			"user data"
//	@Failure		400		{object}	error							"Bad request error"
//	@Router			/users/login-just-by-face [post]
func loginJustByFaceHandler(db *sqlx.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		var req usermodel.UserLoginJustImage
		...
		user, err := repo.LoginWithFaceImage(c, req.FilePath)
		if err != nil {
